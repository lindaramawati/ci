              ...
              <form method="post" role="form" action="<?php echo base_url('admin/order/proses_edit_data/' . $order['id_order']) ?>">
                <input type="hidden" name="id" value="<?php echo $order['id_order'] ?>" id="id">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tanggal_pesanan" id="tanggal_pemesanan" value="<?php echo $order['tanggal_pemesanan'] ?>" placeholder="Masukkan Type">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="no_telepon" id="nama_produk" class="form-control"  value="<?php echo $order['nama_produk'] ?>" placeholder="Masukkan Nama Produk">
                  </div>
                </div>
