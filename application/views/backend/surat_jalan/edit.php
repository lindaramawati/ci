        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="card card-primary">
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" role="form" action="<?php echo base_url('admin/surat_jalan/proses_edit_data/' . $surat_jalan['id_sj']) ?>">
                <input type="hidden" name="id" value="<?php echo $surat_jalan['id_sj'] ?>" id="id">
